...
description: Organizes Effect services with multiple implementations (live, memory) following a consistent module structure convention. Use when creating or refactoring services that have interfaces and multiple implementations.
---
