...
test('type-level parsing: whitespace handling', () => {
  ...
  type _1 = Ts.Test.Cases<
    Ts.Test.bid<SomeLong, FlagName.Analyze<'--version'>>,
    Ts.Test.bid<SomeLong, FlagName.Analyze<' --version'>>,
    Ts.Test.bid<SomeLong, FlagName.Analyze<'  --version '>>,
    Ts.Test.bid<SomeLong, FlagName.Analyze<'  --version  '>>,
    Ts.Test.bid<SomeLong, FlagName.Analyze<' --version  '>>,
  ...
  type _2 = Ts.Test.Cases<
    Ts.Test.bid<SomeShort, FlagName.Analyze<'-v'>>,
    Ts.Test.bid<SomeShort, FlagName.Analyze<' -v'>>,
    Ts.Test.bid<SomeShort, FlagName.Analyze<' -v '>>,
    Ts.Test.bid<SomeShort, FlagName.Analyze<' -v  '>>,
    Ts.Test.bid<SomeShort, FlagName.Analyze<'  -v '>>,
  ...
  type _3 = Ts.Test.Cases<
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'--version -v'>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<' --version -v'>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<' --version -v '>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'  --version -v  '>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'  --version -v '>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'-v --version'>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<' -v --version'>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'  -v --version'>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'  -v --version '>>,
    Ts.Test.bid<SomeLongShort, FlagName.Analyze<'  -v --version  '>>,
  ...
  type _4 = Ts.Test.Cases<
    Ts.Test.bid<SomeLongCamelCase, FlagName.Analyze<'--fooBar'>>,
    Ts.Test.bid<SomeLongCamelCase, FlagName.Analyze<'--foo-bar'>>
  >
})
...
test('type-level validation: empty input', () => {
  type _ = Ts.Test.Cases<
    Ts.Test.bid<FlagName.Errors.Empty, FlagName.Analyze<''>>,
    Ts.Test.bid<FlagName.Errors.Empty, FlagName.Analyze<' '>>
  >
})
...
test('type-level: fromString return types', () => {
  ...
  Ts.Test.bid<FlagName.Analyze<'-v'>>()(FlagName.fromString('-v'))
  Ts.Test.bid<FlagName.Analyze<'--verbose'>>()(FlagName.fromString('--verbose'))
  Ts.Test.bid<FlagName.Analyze<'-v --verbose'>>()(FlagName.fromString('-v --verbose'))
  Ts.Test.bid<FlagName.Analyze<'--foo-bar'>>()(FlagName.fromString('--foo-bar'))
  Ts.Test.bid<FlagName.Analyze<'-v --verbose -x --extra'>>()(FlagName.fromString('-v --verbose -x --extra'))
