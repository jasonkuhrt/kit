 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<EquivKind, [unknown, Kind.Apply<Parameter1, [$Actual]>]>
const unknown_ = runtime.parameter1.equiv.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<EquivKind, [any, Kind.Apply<Parameter1, [$Actual]>]>
const any_ = runtime.parameter1.equiv.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<EquivKind, [never, Kind.Apply<Parameter1, [$Actual]>]>
const never_ = runtime.parameter1.equiv.never

const ofAs_ = runtime.parameter1.equiv.ofAs
/**
 * No-excess variant of equiv relation.
 * Checks that actual has no excess properties beyond expected.
 */
type noExcess_<$Expected, $Actual> = Kind.Apply<EquivNoExcessKind, [$Expected, Kind.Apply<Parameter1, [$Actual]>]>
const noExcess_ = runtime.parameter1.equiv.noExcess
const noExcessAs_ = runtime.parameter1.equiv.noExcessAs
