 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<ExactKind, [unknown, Kind.Apply<Parameter1, [$Actual]>]>
const unknown_ = runtime.parameter1.exact.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<ExactKind, [any, Kind.Apply<Parameter1, [$Actual]>]>
const any_ = runtime.parameter1.exact.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<ExactKind, [never, Kind.Apply<Parameter1, [$Actual]>]>
const never_ = runtime.parameter1.exact.never

const ofAs_ = runtime.parameter1.exact.ofAs
type noExcess_ = never
const noExcess_ = runtime.parameter1.exact.noExcess
