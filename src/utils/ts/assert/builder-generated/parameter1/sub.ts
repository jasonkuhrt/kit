...
const of_ = runtime.parameter1.sub.of
...
const string_ = runtime.parameter1.sub.string
...
const number_ = runtime.parameter1.sub.number
...
const bigint_ = runtime.parameter1.sub.bigint
...
const boolean_ = runtime.parameter1.sub.boolean
...
const undefined_ = runtime.parameter1.sub.undefined
...
const null_ = runtime.parameter1.sub.null
...
const symbol_ = runtime.parameter1.sub.symbol
...
const Date_ = runtime.parameter1.sub.Date
...
const RegExp_ = runtime.parameter1.sub.RegExp
...
const Error_ = runtime.parameter1.sub.Error
...
const Promise_ = runtime.parameter1.sub.Promise
...
const Array_ = runtime.parameter1.sub.Array
 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<SubKind, [unknown, Kind.Apply<Parameter1, [$Actual]>]>
const unknown_ = runtime.parameter1.sub.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<SubKind, [any, Kind.Apply<Parameter1, [$Actual]>]>
const any_ = runtime.parameter1.sub.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<SubKind, [never, Kind.Apply<Parameter1, [$Actual]>]>
const never_ = runtime.parameter1.sub.never

const ofAs_ = runtime.parameter1.sub.ofAs
/**
 * No-excess variant of sub relation.
 * Checks that actual has no excess properties beyond expected.
 */
type noExcess_<$Expected, $Actual> = Kind.Apply<SubNoExcessKind, [$Expected, Kind.Apply<Parameter1, [$Actual]>]>
const noExcess_ = runtime.parameter1.sub.noExcess
const noExcessAs_ = runtime.parameter1.sub.noExcessAs
