 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<EquivKind, [unknown, Kind.Apply<Parameter5, [$Actual]>]>
const unknown_ = runtime.parameter5.equiv.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<EquivKind, [any, Kind.Apply<Parameter5, [$Actual]>]>
const any_ = runtime.parameter5.equiv.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<EquivKind, [never, Kind.Apply<Parameter5, [$Actual]>]>
const never_ = runtime.parameter5.equiv.never

const ofAs_ = runtime.parameter5.equiv.ofAs
/**
 * No-excess variant of equiv relation.
 * Checks that actual has no excess properties beyond expected.
 */
type noExcess_<$Expected, $Actual> = Kind.Apply<EquivNoExcessKind, [$Expected, Kind.Apply<Parameter5, [$Actual]>]>
const noExcess_ = runtime.parameter5.equiv.noExcess
const noExcessAs_ = runtime.parameter5.equiv.noExcessAs
