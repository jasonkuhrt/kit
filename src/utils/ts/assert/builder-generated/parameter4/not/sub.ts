 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<SubKind, [unknown, Kind.Apply<Parameter4, [$Actual]>, true]>
const unknown_ = runtime.parameter4.not.sub.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<SubKind, [any, Kind.Apply<Parameter4, [$Actual]>, true]>
const any_ = runtime.parameter4.not.sub.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<SubKind, [never, Kind.Apply<Parameter4, [$Actual]>, true]>
const never_ = runtime.parameter4.not.sub.never

const ofAs_ = runtime.parameter4.not.sub.ofAs
