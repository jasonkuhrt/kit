 ...
 * ```
 */
type unknown_<$Actual> = Kind.Apply<ExactKind, [unknown, Kind.Apply<Parameter4, [$Actual]>]>
const unknown_ = runtime.parameter4.exact.unknown
 ...
 * ```
 */
type any_<$Actual> = Kind.Apply<ExactKind, [any, Kind.Apply<Parameter4, [$Actual]>]>
const any_ = runtime.parameter4.exact.any
 ...
 * ```
 */
type never_<$Actual> = Kind.Apply<ExactKind, [never, Kind.Apply<Parameter4, [$Actual]>]>
const never_ = runtime.parameter4.exact.never

const ofAs_ = runtime.parameter4.exact.ofAs
type noExcess_ = never
const noExcess_ = runtime.parameter4.exact.noExcess
