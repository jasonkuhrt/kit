...
import type { Radians } from './radians/$$.ts'
import type { Whole } from './whole/$$.ts'
 ...
 */
export type Ceil<T extends number> = Int
 ...
 */
export type Trunc<T extends number> = Int
 ...
 *
 * @example
 * import { from as nonNegative } from './non-negative/$$.ts'
 * import { from as positive } from './positive/$$.ts'
 *
 ...
 */
export type Sin<T extends number> = InRange<-1, 1>
 ...
 */
export type Cos<T extends number> = InRange<-1, 1>
 ...
 *
 * @example
 * import { from as int } from './int/$$.ts'
 *
