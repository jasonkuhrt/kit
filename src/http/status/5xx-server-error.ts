 ...
 */
export const InternalServerError = { code: 500 as const, description: `Internal Server Error` } satisfies Status

/**
 * The request method is not supported by the server and cannot be handled.
 * @see https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/501
 */
export const NotImplemented = { code: 501 as const, description: `Not Implemented` } satisfies Status
 ...
 */
export const ServiceUnavailable = { code: 503 as const, description: `Service Unavailable` } satisfies Status

/**
 * This error response is given when the server is acting as a gateway and cannot get a response in time.
 * @see https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/504
 */
export const GatewayTimeout = { code: 504 as const, description: `Gateway Timeout` } satisfies Status
 ...
 */
export const VariantAlsoNegotiates = { code: 506 as const, description: `Variant Also Negotiates` } satisfies Status

/**
 * The method could not be performed on the resource because the server is unable to store the representation needed to successfully complete the request.
 * @see https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/507
 */
export const InsufficientStorage = { code: 507 as const, description: `Insufficient Storage` } satisfies Status
