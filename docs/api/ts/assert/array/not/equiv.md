...
type Array_<$Actual> = Kind.Apply<
  EquivKind,
  [any[], Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type bigint_<$Actual> = Kind.Apply<
  EquivKind,
  [bigint, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type boolean_<$Actual> = Kind.Apply<
  EquivKind,
  [boolean, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type Date_<$Actual> = Kind.Apply<
  EquivKind,
  [Date, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type Error_<$Actual> = Kind.Apply<
  EquivKind,
  [Error, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type null_<$Actual> = Kind.Apply<
  EquivKind,
  [null, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type number_<$Actual> = Kind.Apply<
  EquivKind,
  [number, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type of_<$Expected, $Actual> = Kind.Apply<
  EquivKind,
  [$Expected, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type Promise_<$Actual> = Kind.Apply<
  EquivKind,
  [Promise<any>, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type RegExp_<$Actual> = Kind.Apply<
  EquivKind,
  [RegExp, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type string_<$Actual> = Kind.Apply<
  EquivKind,
  [string, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type symbol_<$Actual> = Kind.Apply<
  EquivKind,
  [symbol, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
...
type undefined_<$Actual> = Kind.Apply<
  EquivKind,
  [undefined, Kind.Apply<ArrayElement, [$Actual]>, true]
>
```
