...
### <span style="opacity: 0.6; font-weight: normal; font-size: 0.85em;">`[C]`</span> `Array`<SourceLink inline href="https://github.com/jasonkuhrt/kit/blob/main/./src/utils/ts/assert/builder-generated/returned/not/sub.ts#L222" /> {#c-array-222}
...
### <span style="opacity: 0.6; font-weight: normal; font-size: 0.85em;">`[C]`</span> `Promise`<SourceLink inline href="https://github.com/jasonkuhrt/kit/blob/main/./src/utils/ts/assert/builder-generated/returned/not/sub.ts#L206" /> {#c-promise-206}
...
### <span style="opacity: 0.6; font-weight: normal; font-size: 0.85em;">`[T]`</span> `Array`<SourceLink inline href="https://github.com/jasonkuhrt/kit/blob/main/./src/utils/ts/assert/builder-generated/returned/not/sub.ts#L221" /> {#t-array-221}

```typescript
type Array_<$Actual> = Kind.Apply<
  SubKind,
  [any[], Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type bigint_<$Actual> = Kind.Apply<
  SubKind,
  [bigint, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type boolean_<$Actual> = Kind.Apply<
  SubKind,
  [boolean, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type Date_<$Actual> = Kind.Apply<
  SubKind,
  [Date, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type Error_<$Actual> = Kind.Apply<
  SubKind,
  [Error, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
### <span style="opacity: 0.6; font-weight: normal; font-size: 0.85em;">`[T]`</span> `null`<SourceLink inline href="https://github.com/jasonkuhrt/kit/blob/main/./src/utils/ts/assert/builder-generated/returned/not/sub.ts#L125" /> {#t-null-125}

```typescript
type null_<$Actual> = Kind.Apply<
  SubKind,
  [null, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type number_<$Actual> = Kind.Apply<
  SubKind,
  [number, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type of_<$Expected, $Actual> = Kind.Apply<
  SubKind,
  [$Expected, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
### <span style="opacity: 0.6; font-weight: normal; font-size: 0.85em;">`[T]`</span> `Promise`<SourceLink inline href="https://github.com/jasonkuhrt/kit/blob/main/./src/utils/ts/assert/builder-generated/returned/not/sub.ts#L205" /> {#t-promise-205}

```typescript
type Promise_<$Actual> = Kind.Apply<
  SubKind,
  [Promise<any>, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type RegExp_<$Actual> = Kind.Apply<
  SubKind,
  [RegExp, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type string_<$Actual> = Kind.Apply<
  SubKind,
  [string, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type symbol_<$Actual> = Kind.Apply<
  SubKind,
  [symbol, Kind.Apply<Returned, [$Actual]>, true]
>
```
...
type undefined_<$Actual> = Kind.Apply<
  SubKind,
  [undefined, Kind.Apply<Returned, [$Actual]>, true]
>
```
