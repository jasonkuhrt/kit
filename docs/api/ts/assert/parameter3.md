...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Awaited$>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Returned>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, ArrayElement>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Parameters$>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Parameter1>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Parameter2>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Parameter4>>
```
...
```typescript
Builder<State.AddExtractor<State.AddExtractor<State.Empty, Parameter3>, Parameter5>>
```
